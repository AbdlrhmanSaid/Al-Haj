...
const Navbar = () => {
  ...
  return (
    <header className="bg-gradient-to-r from-[#A17D23] via-[#D3B159] to-[#F8F4E8] shadow-xl sticky top-0 z-50 backdrop-blur-sm bg-opacity-90">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 md:h-20">
          {/* Logo with advanced hover animation */}
